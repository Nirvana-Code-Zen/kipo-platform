...
export function AuthInput({ label, showLabel, suffix, error, id, ...rest }: AuthInputProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div
        className={[
          'flex items-center gap-2 bg-muted rounded-[14px] px-4 transition-[border-color,box-shadow] duration-150 border-[1.5px]',
