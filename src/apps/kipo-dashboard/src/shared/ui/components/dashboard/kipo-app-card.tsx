...
export function KipoAppCard() {
  ...
  return (
    <Card
      className="text-background p-4 transition-all duration-500 hover:shadow-2xl animate-slide-in-up overflow-hidden relative group"
      style={{ animationDelay: "900ms", background: "var(--color-foreground)", color: "var(--color-background)" }}
    >
