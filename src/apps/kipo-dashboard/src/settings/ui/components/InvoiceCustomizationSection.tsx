...
import type { UIFiscalSettings, UIInvoiceDisplayOptions } from "./types"
...
function hasCustomDisplayOptions(displayOptions: UIInvoiceDisplayOptions | undefined): boolean {
