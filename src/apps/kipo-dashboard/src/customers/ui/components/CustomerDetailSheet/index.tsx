...
import type { CustomerDetailSheetProps, DetailRowProps } from "./types"
...
function RfcTypeTag({ taxId }: { taxId: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5">
      ...
      <span className="text-[12px] font-sans font-semibold text-[var(--brand)]">
...
function DetailRow({ icon, label, value, extra }: DetailRowProps) {
  return (
