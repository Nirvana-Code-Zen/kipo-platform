...
import { FACTURAPI_ORIGIN } from "./constants"

import type { ManifiestoSignPortalProps } from "./types"
        ...
        {(justSigned || isConfirming || error) && (
          <div
            ...
            className={`mx-5 mt-4 px-3.5 py-2.5 rounded-xl text-[13px] font-sans flex-shrink-0 ${
              error ? "bg-[var(--kipo-danger-bg)] border-[1.5px] border-[var(--kipo-danger)] text-[var(--kipo-danger)]" : "bg-muted text-foreground"
            }`}
          >
