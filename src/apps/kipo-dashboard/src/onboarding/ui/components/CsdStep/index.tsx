...
import type { CsdStepProps, FilePickerProps } from "./types"
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <button
        ...
        className={`flex items-center gap-2 bg-muted border-transparent rounded-[14px] px-4 py-3.5 text-sm font-sans text-left w-full cursor-pointer border-[1.5px] ${
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-background px-4 py-6">
      <div className="w-full max-w-[480px]">
        ...
        {displayError && (
          <div className="bg-[var(--kipo-danger-bg)] border-[1.5px] border-destructive rounded-xl px-3.5 py-2.5 text-[13px] text-destructive font-sans mb-5">
            {displayError}
          </div>
        )}
